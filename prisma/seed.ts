...
async function main() {
  ...
  const categories = [
    ...
    { name: 'Hogar',           slug: 'hogar',           icon: '🏠', color: '#4E342E', order: 10 },
    ...
    { name: 'Shoppings',       slug: 'shoppings',       icon: '🏬', color: '#37474F', order: 17 },
    { name: 'Automotores',     slug: 'automotores',     icon: '🚗', color: '#263238', order: 18 },
    { name: 'Otros',           slug: 'otros',           icon: '🏷️', color: '#546E7A', order: 19 },
