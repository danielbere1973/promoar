...
# Output from the dump analysis + new mappings
categories_ts = """export interface CategoryNode {
  id: string
  name: string
  cotoId?: string
  carrefourId?: string
...
with open('app/precios/categories.ts', 'w', encoding='utf-8') as f:
    f.write(categories_ts)

print("Categories replaced successfully.")
