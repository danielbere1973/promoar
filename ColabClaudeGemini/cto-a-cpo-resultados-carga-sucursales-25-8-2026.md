...
Siguiendo la recomendación del dictamen, continúo con **Colorshop** (307 sucursales, 24 provincias, ya documentado y sin WAF) como próxima fuente de esta tanda, y evalúo ICBC (requiere el mismo bypass local de WAF que el scraper de promos).
