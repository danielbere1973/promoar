...
const MACRO_CARD_MAP: Record<string, { cardNetworkName: string; segmentName: string; cardTier: 'SELECTA' | null } | null> = {
  ...
  // Mastercard Crédito
  'Mastercard Black Macro Selecta':       { cardNetworkName: 'Mastercard Crédito',     segmentName: 'Mastercard Black Macro Selecta',        cardTier: 'SELECTA' },
  'Mastercard Gold':                      { cardNetworkName: 'Mastercard Crédito',     segmentName: 'Gold',                                  cardTier: null },
  'Mastercard Internacional':             { cardNetworkName: 'Mastercard Crédito',     segmentName: 'Internacional',                         cardTier: null },
  'Mastercard Platinum':                  { cardNetworkName: 'Mastercard Crédito',     segmentName: 'Platinum',                              cardTier: null },
  'Mastercard Regional':                  { cardNetworkName: 'Mastercard Crédito',     segmentName: 'Regional',                              cardTier: null },
  // Visa Crédito
  'Visa Gold':                            { cardNetworkName: 'Visa Crédito',           segmentName: 'Gold',                                  cardTier: null },
  'Visa Internacional':                   { cardNetworkName: 'Visa Crédito',           segmentName: 'Internacional',                         cardTier: null },
  'Visa Nacional':                        { cardNetworkName: 'Visa Crédito',           segmentName: 'Nacional',                              cardTier: null },
  'Visa Platinum':                        { cardNetworkName: 'Visa Crédito',           segmentName: 'Platinum',                              cardTier: null },
  'Visa Signature Macro Selecta':         { cardNetworkName: 'Visa Crédito',           segmentName: 'Visa Signature Macro Selecta',          cardTier: 'SELECTA' },
  // Visa Débito Macro
  'Visa Débito Macro':                    { cardNetworkName: 'Visa Debito',            segmentName: 'Visa Débito Macro',                     cardTier: null },
  'Visa Débito Macro Selecta':            { cardNetworkName: 'Visa Debito',            segmentName: 'Visa Débito Macro Selecta',             cardTier: 'SELECTA' },
