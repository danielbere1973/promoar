  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-700/50">
            ...
            {SECTIONS.map(s => (
              <button key={s.id}
                ...
                className={`flex items-center gap-1.5 px-3.5 py-2 rounded-2xl text-xs font-bold whitespace-nowrap transition-all shrink-0
                  ${!s.available ? 'opacity-40 cursor-default bg-gray-50 dark:bg-slate-700 text-gray-400 dark:text-slate-500 border border-gray-100' :
                    active === s.id
      ...
      <div className="px-4 pb-32 max-w-lg mx-auto">
        <div className="flex items-start gap-2 bg-gray-50 dark:bg-slate-700 border border-gray-100 rounded-2xl p-4">
