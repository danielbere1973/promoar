                        ...
                        <div className="space-y-2">
                          {np.entityType === 'bank' ? (
                            productNetworks.length === 0 ? (
                              <p className="text-sm font-medium text-gray-500 py-4 text-center">
                                              ...
                                              >
                                                ...
                                                {isSelected && modoWallet && (
                                                  <button
                                                    ...
                                                    className={`flex items-center gap-2 px-2.5 py-1 rounded-lg border-2 transition-all ${inModo ? 'bg-blue-600 border-blue-600 text-white' : 'bg-white border-gray-200 text-gray-400'}`}
                                                  >
