...
const SOURCE_LABELS: { label: string; value: string }[] = [
  ...
  { label: 'MercadoPago',  value: 'mercadopago.com.ar' },
  { label: 'Cuenta DNI',   value: 'cuentadni' },
  { label: 'Brubank',      value: 'brubank.com' },
  { label: 'Openpay',      value: 'openpayargentina.com.ar' },
  { label: 'Club La Nación', value: 'lanacion.com.ar' },
  { label: 'Clarín 365',   value: 'clarin.com' },
  ...
  { label: 'Cabal',        value: 'bancocredicoop.coop' },
  { label: 'Galicia',      value: 'bancogalicia.com' },
  ...
  { label: 'Patagonia',    value: 'bancopatagonia.com.ar' },
  { label: 'ICBC',         value: 'icbc.com.ar' },
]
