                  ...
                  {selectedPromo.requirements.map((r, idx) => (
                    <div key={idx} className="bg-gray-50 border border-gray-100 rounded-2xl p-4 flex items-center justify-between group hover:border-indigo-200 transition-colors">
                      ...
                      <div className="text-right shrink-0">
                        <p className="text-lg font-extrabold text-indigo-600">{r.discountValue}%</p>
                        <p className="text-[9px] text-gray-400 font-bold uppercase tracking-wider">{r.discountType === 'PERCENTAGE_REINTEGRO' ? 'Reintegro' : 'Directo'}</p>
                      </div>
                    </div>
                  ))}
                </div>
